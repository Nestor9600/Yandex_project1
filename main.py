...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        self.button_1.setStyleSheet("background-color: {}; color: {};".format('#004444', '#FFFFFF'))
...
class Prod(QWidget):
    ...
    def initUI(self):
        ...
        self.button_phizics.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
        ...
        self.button_maths.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
        ...
        self.button_back.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
...
class Prod1(QWidget):
    ...
    def initUI(self):
        ...
        self.button_9.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
        ...
        self.button_10.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
        ...
        self.button_11.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
    ...
    def run9(self):
        if self.subject == 'phizics':
            self.theme, ok_pressed = QInputDialog.getItem(self, "Выбери", "Тема, которую хочешь изучать", ("Механика, 9 класс", "Тепловые явления, 9 класс", "Электричество, 9 класс", "Оптика, 9 класс"), 1, False)
            if ok_pressed:
                self.close()
    ...
    def run10(self):
        if self.subject == 'phizics':
            self.theme, ok_pressed = QInputDialog.getItem(self, "Выбери", "Тема, которую хочешь изучать", ("Механика, 10 класс", "Молекулярная физика и термодинамика, 10 класс", "Электростатика, 10 класс", "Электрический ток, 10 класс", "Оптика, 10 класс"), 1, False)
            if ok_pressed:
                self.close()
                self.w = Prod2(self.theme, self.subject)
                self.w.show()
    ...
    def run11(self):
        if self.subject == 'phizics':
            self.theme, ok_pressed = QInputDialog.getItem(self, "Выбери", "Тема, которую хочешь изучать", ("Механика, 11 класс", "Молекулярная физика и термодинамика, 11 класс", "Электричество и магнетизм, 11 класс", "Оптика, 11 класс", "Атомы, ядра, кванты, 11 класс"), 1, False)
            if ok_pressed:
                self.close()
                self.w = Prod2(self.theme, self.subject)
                self.w.show()
...
class Prod2(QWidget):
    ...
    def initUI(self):
        ...
        self.button_1.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
        ...
        self.button_2.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
        ...
        self.button_3.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
        ...
        self.button_4.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
        ...
        self.button_5.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
        ...
        self.button_6.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
        ...
        self.button_7.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
        ...
        self.button_8.setStyleSheet("background-color: {}; color: {};".format('#880000', '#FFFFFF'))
    ...
    def run1(self):
        ...
        cur = con.cursor()
        self.exercise = cur.execute("""SELECT exercise FROM subjects WHERE theme = ? AND number = 1""",(self.theme,)).fetchone()
        self.answer = cur.execute("""SELECT answer FROM subjects WHERE theme = ? AND number = 1""",(self.theme,)).fetchone()
        con.close()
        self.close()
    ...
    def run2(self):
        con = sqlite3.connect("films_db.sqlite")
        cur = con.cursor()
        self.exercise = cur.execute("""SELECT exercise FROM subjects WHERE theme = ? AND number = 2""",(self.theme,)).fetchone()
        self.answer = cur.execute("""SELECT answer FROM subjects WHERE theme = ? AND number = 2""",(self.theme,)).fetchone()
        con.close()
        self.close()
        self.w = Prod3(self.exercise, self.theme, self.answer, self.subject)
        self.w.show()
    ...
    def run3(self):
        con = sqlite3.connect("films_db.sqlite")
        cur = con.cursor()
        self.exercise = cur.execute("""SELECT exercise FROM subjects WHERE theme = ? AND number = 3""",(self.theme,)).fetchone()
        self.answer = cur.execute("""SELECT answer FROM subjects WHERE theme = ? AND number = 3""",(self.theme,)).fetchone()
        con.close()
        self.close()
        self.w = Prod3(self.exercise, self.theme, self.answer, self.subject)
        self.w.show()
    ...
    def run4(self):
        con = sqlite3.connect("films_db.sqlite")
        cur = con.cursor()
        self.exercise = cur.execute("""SELECT exercise FROM subjects WHERE theme = ? AND number = 4""",(self.theme,)).fetchone()
        self.answer = cur.execute("""SELECT answer FROM subjects WHERE theme = ? AND number = 4""",(self.theme,)).fetchone()
        con.close()
        self.close()
        self.w = Prod3(self.exercise, self.theme, self.answer, self.subject)
        self.w.show()
    ...
    def run5(self):
        con = sqlite3.connect("films_db.sqlite")
        cur = con.cursor()
        self.exercise = cur.execute("""SELECT exercise FROM subjects WHERE theme = ? AND number = 5""",(self.theme,)).fetchone()
        self.answer = cur.execute("""SELECT answer FROM subjects WHERE theme = ? AND number = 5""",(self.theme,)).fetchone()
        con.close()
        self.close()
        self.w = Prod3(self.exercise, self.theme, self.answer, self.subject)
        self.w.show()
    ...
    def run6(self):
        con = sqlite3.connect("films_db.sqlite")
        cur = con.cursor()
        self.exercise = cur.execute("""SELECT exercise FROM subjects WHERE theme = ? AND number = 6""",(self.theme,)).fetchone()
        self.answer = cur.execute("""SELECT answer FROM subjects WHERE theme = ? AND number = 6""",(self.theme,)).fetchone()
        con.close()
        self.close()
        self.w = Prod3(self.exercise, self.theme, self.answer, self.subject)
        self.w.show()
    ...
    def run7(self):
        con = sqlite3.connect("films_db.sqlite")
        cur = con.cursor()
        self.exercise = cur.execute("""SELECT exercise FROM subjects WHERE theme = ? AND number = 7""",(self.theme,)).fetchone()
        self.answer = cur.execute("""SELECT answer FROM subjects WHERE theme = ? AND number = 7""",(self.theme,)).fetchone()
        con.close()
        self.close()
        self.w = Prod3(self.exercise, self.theme, self.answer, self.subject)
        self.w.show()
    ...
    def run8(self):
        con = sqlite3.connect("films_db.sqlite")
        cur = con.cursor()
        self.exercise = cur.execute("""SELECT exercise FROM subjects WHERE theme = ? AND number = 8""",(self.theme,)).fetchone()
        self.answer = cur.execute("""SELECT answer FROM subjects WHERE theme = ? AND number = 8""",(self.theme,)).fetchone()
        con.close()
        self.close()
        self.w = Prod3(self.exercise, self.theme, self.answer, self.subject)
        self.w.show()
    ...
    def run9(self):
        con = sqlite3.connect("films_db.sqlite")
        cur = con.cursor()
        self.exercise = cur.execute("""SELECT exercise FROM subjects WHERE theme = ? AND number = 9""",(self.theme,)).fetchone()
        self.answer = cur.execute("""SELECT answer FROM subjects WHERE theme = ? AND number = 9""",(self.theme,)).fetchone()
        con.close()
        self.close()
        self.w = Prod3(self.exercise, self.theme, self.answer, self.subject)
        self.w.show()
    ...
    def run10(self):
        con = sqlite3.connect("films_db.sqlite")
        cur = con.cursor()
        self.exercise = cur.execute("""SELECT exercise FROM subjects WHERE theme = ? AND number = 10""",(self.theme,)).fetchone()
        self.answer = cur.execute("""SELECT answer FROM subjects WHERE theme = ? AND number = 10""",(self.theme,)).fetchone()
        con.close()
        self.close()
        self.w = Prod3(self.exercise, self.theme, self.answer, self.subject)
        self.w.show()
